...
const serviceCategories = [
  {
    ...
    description: "We build functional, market-ready MVPs in weeks, not months. Our experienced team combines agile methodology with cutting-edge technology to deliver high-quality products quickly.",
    icon: Rocket,
    features: [
  ...
  },
  {
    ...
    description: "Create intuitive, engaging user experiences that solve real problems. Our design process focuses on understanding your users and crafting interfaces that deliver value from day one.",
    icon: PenTool,
    features: [
      "User research",
      "UX/UI design",
  ...
  {
    title: "Launch & Scale",
    description: "From initial launch to scaling your user base, we help you grow and adapt your product based on real-world feedback and analytics.",
    icon: TrendingUp,
    features: [
      "Growth strategy",
      "Marketing website",
  ...
  },
  {
    ...
    description: "Get expert feedback on your idea, market fit analysis, and actionable recommendations from our team of experienced startup advisors.",
    icon: HelpCircle,
    features: [
      "Idea validation",
      "Market research",
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="From MVP development to launch and scale, SeedMVP offers comprehensive services to help startups succeed."
        />
      </Helmet>
      <div className="pt-24">
        {/* Hero Section */}
          ...
          <div className="container-tight">
            <div className="text-center">
              ...
              <p className="text-lg md:text-xl max-w-2xl mx-auto text-white/80">
                ...
                Our team of experts will help you at every step of your startup journey.
              </p>
            </div>
          </div>
        </div>
              ...
              {serviceCategories.map((service, index) => (
                ...
                >
                  <div className="md:w-1/2">
                    <div className="w-16 h-16 bg-seedmvp-blue/10 rounded-xl flex items-center justify-center mb-6">
                      <service.icon className="h-8 w-8 text-seedmvp-blue" />
                    </div>
                    ...
                    <ul className="space-y-2 mb-6">
                      {service.features.map((feature, i) => (
                        <li key={i} className="flex items-start">
                          <CheckCircle className="h-5 w-5 text-seedmvp-blue mr-2 mt-0.5 flex-shrink-0" />
                          <span>{feature}</span>
                        </li>
                      ))}
                    </ul>
                    
                    <div className="p-4 bg-seedmvp-blue/10 rounded-lg">
                      <h3 className="text-lg font-semibold mb-2">Why Choose This Service:</h3>
                      <p>{service.benefits}</p>
                    </div>
                  </div>
                  
                  <div className="md:w-1/2 bg-seedmvp-gray-light rounded-xl p-8">
                    <div className="aspect-video bg-white rounded-lg shadow-md flex items-center justify-center">
                      <service.icon className="h-24 w-24 text-seedmvp-blue opacity-20" />
                    </div>
                  </div>
                </div>
              ))}
        ...
        {/* Additional Services */}
        <div className="section bg-seedmvp-gray-light">
          <div className="container-tight">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4">Additional Services</h2>
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                We offer a range of specialized services that can be added to any package 
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-6">
              {additionalServices.map((service, index) => (
                <div key={index} className="bg-white rounded-lg p-6 text-center shadow-md">
                  <div className="mx-auto w-12 h-12 bg-seedmvp-blue/10 rounded-full flex items-center justify-center mb-4">
